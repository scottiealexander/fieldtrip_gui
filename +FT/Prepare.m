...
%initialize the FT_DATA struct    
    FT_DATA = struct(...
         'organization',FT.organize.Organization,...
         'size'     , []     ,...         
         'data'     , []     ,...
         'event'    , []     ,...
         'epoch'    , []     ,...
    ...
    cInit = {{'organization','getcurr','study'},...
             {'organization','getcurr','template'},...
             {'organization','getcurr','subject'},...
             {'organization','getcurr','dataset'},...
             'size'};
