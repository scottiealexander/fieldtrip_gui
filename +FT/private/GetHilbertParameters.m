...
%TODO
%	add linear vs log spacing
%	add option to compute surrogate psd
...
%linear or log spacing
	...
	hLog = uicontrol('Style','checkbox','Units','normalized','Position',[.67 .29 .07 .08],...
			'BackgroundColor',[1 1 1],'Min',0,'Max',1,'Value',cfg.log,'Parent',h);

%compute surrogate dataset
    uicontrol('Style','text','String','Generate surrogate dataset?:',...
            'Units','normalized','FontSize',12,'FontWeight','bold',...
            'Position',[0 .14 .65 .1],'BackgroundColor',bgColor,...
            'Parent',h,'HorizontalAlignment','right');
            
	hSur = uicontrol('Style','checkbox','Units','normalized','Position',[.67 .17 .07 .08],...
