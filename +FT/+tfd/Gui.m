...
c = {...
    ...
    {'edit','size',5,'String',num2str(params.lo),'tag','lo','valfun',@CheckFreqN};...
    {'text','String','Ending Frequency [Hz]:'},...
    {'edit','size',5,'String',num2str(params.hi),'tag','hi','valfun',@CheckFreqN};...
    {'text','String','Number of bins:'},...
    {'edit','size',5,'String',num2str(params.n),'tag','n','valfun',@CheckFreqN};...
    {'text','String','Bin width [%]:'},...
    {'edit','size',5,'String',num2str(params.w),'tag','w','valfun',{'inrange',1,90,true}};...
    ...
